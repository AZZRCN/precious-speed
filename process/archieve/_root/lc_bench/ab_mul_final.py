#!/usr/bin/env python3
"""ab_mul_final.py - Final 10-round A/B benchmark, CUR O2 vs BEST O2."""
import subprocess, os, time

CUR = r"d:\precious_speed\lc_bench\exe\cur_mul_iter.exe"
BEST = r"d:\precious_speed\lc_bench\exe\cur_mul_final.exe"
...
print(f"{'case':<22} {'CUR_med':>8} {'BEST_med':>8} {'diff':>7} {'%':>7} {'wins':>7}")
print("-" * 67)
...
print(f"\nCUR EXE: 224.7 KB, BEST EXE: 237.6 KB (CUR {-12.9} KB smaller)")
