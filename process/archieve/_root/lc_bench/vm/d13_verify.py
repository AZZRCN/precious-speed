#!/usr/bin/env python3
"""D13 正确性验证驱动: 上传 div_D13.cpp + d8_verify.py, 后台跑 554 例, 写日志。

用法:
    python d13_verify.py          # 启动后台验证
    python d13_verify.py poll     # 查看进度
"""
import os
import sys
...
LOG = "/home/azzr/divbench/logs/d13_verify.log"
...
run(f"cd /home/azzr && nohup python3 d8_verify.py div_D13 > {LOG} 2>&1 &  echo started",
    timeout=30)
