...
// 编译选项 (LC 真实环境: -O2 -std=gnu++20 -static -DONLINE_JUDGE)
// moptm.cpp 顶部 #pragma GCC optimize("O3,unroll-loops") 会自动提升至 O3
// best/*.cpp 无 pragma, 保持纯 -O2 (LC 评测真实情况)
static const char *MOPTM_FLAGS = "-O2 -std=gnu++20 -static -DONLINE_JUDGE";
static const char *BEST_FLAGS  = "-O2 -std=gnu++20 -static -DONLINE_JUDGE";
