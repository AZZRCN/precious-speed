...
# 测试: gmp_newton_verify = USE_GMP_NEWTON + 用 absInvNewton + 验证逻辑
# 如果还是 4 FAIL，说明问题在验证逻辑
# 如果 0 FAIL，说明问题在 absInvNewtonGMP
configs = [
    ("gmp_newton_verify", "-DUSE_GMP_NEWTON -DDISABLE_2NXN_CYCLIC -DCYCLIC_MIN_K=1000000"),
]
