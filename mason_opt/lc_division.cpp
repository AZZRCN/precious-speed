// Library Checker: Division of Big Integers
// https://judge.yosupo.jp/problem/division_of_big_integers
// 输入: T / A B (T 组，A>=0, B>0)
// 输出: 每组一行 "q r" (空格分隔，q=floor(A/B), r=A-qB)
// I/O: mmap 输入 + 32MB oBuffer 输出 + SWAR 快读（比原作者 origin_div 更激进的 I/O）
