...
// ---- THP: BSS 约 70 MiB (WORK 25.6M + FB/GB + I/O 19M + limb 缓冲)。
// 4 KiB 页需上万次 minor fault (实测 sys≈user)。THP=madvise 时内核不主动给
// 2 MiB 页, 必须显式 madvise 整个 BSS 段。内缩到 2 MiB 对齐边界; always/never 均无害。
