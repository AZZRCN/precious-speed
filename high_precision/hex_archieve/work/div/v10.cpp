...
// ============================ 状态 (未提交 LC) ============================
// 候选 v10: v9 (radix-4 FFT, LEAF=10) + 标量 split_b2 -> MUL 的 AVX2 gather 向量版。
// 正确性: 27/27 官方 HEX 用例 (hexcheck.py) 全过。
// 性能 (cachegrind I refs, Zen3 几何, 相对 hb_div 历史标杆):
//   max_00         9.49M  (-15.1%)
//   large_00       7.10M  (-19.2%)
//   a_max_b_random 324.5M (-26.7%)   <- 主导大用例, 较 v9 (348.1M) 再 -6.8%
// 相对 v9: 小用例持平, 大用例 -6.8%; LEAF=10 仍最优 (LEAF 9/11 均劣)。
// >>> 未提交 LC (铁律 #2 只通知不代交)。提交: division_of_big_integers_hex, C++23。
// =================================================================
// HEX division v10 (vectorized split_b2)  (A>=0, B>0, floor 除法, 输出 "q r")
