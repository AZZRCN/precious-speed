...
static constexpr int MAXC = 8000;          // 1.6M hex / 16
#ifndef BZ_CUTOFF
...
alignas(HP) static u64 WORK[800000];                    // Newton/BZ 工作栈 (~32MB), 峰值约 16*n
static u64* wp = WORK;

static constexpr u32 LMMAX = 1u << 18;
...
static constexpr u32 FMCAP = 1u << 18;
